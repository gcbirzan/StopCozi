 ...
 */
var translate = ['$translate', '$q', '$interpolate', '$compile', '$parse', '$rootScope', 'CONFIG', 'translationFactory',
    function ($translate, $q, $interpolate, $compile, $parse, $rootScope, CONFIG, translationFactory) {
        return {
            restrict: 'AE',
            scope: true,
            compile: function (tElement, tAttr) {
                ...
                return function linkFn(scope, iElement, iAttr) {
                    ...
                    var updateTranslation = function(translateAttr, translationId, scope, interpolateParams) {
                        ...
                        translationFactory.check(translationId);
                        ...
                        $translate(translationId, interpolateParams, translateInterpolation)
                            .then(function (translation) {
                                ...
                                if (angular.isString(translationId) && translationId.length > 0 && translationId.indexOf('|') != -1) {
                                    return $translate(translationId.split('|').pop().trim(), interpolateParams, translateInterpolation);
                                } else {
                                    var deferred = $q.defer();
